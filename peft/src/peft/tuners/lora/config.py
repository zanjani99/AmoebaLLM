...
class LoraConfig(PeftConfig):
    ...
    num_experts: int = field(
        ...
        metadata={
            "help": (
                "number of experts in MoE-based LoRA."
            )
        },
    )
    ...
    top_k: int = field(
        ...
        metadata={
            "help": (
                "topk in MoE-based LoRA."
            )
        },
    )

    moe_lora_v2: bool = field(
        default=False,
        metadata={
            "help": (
                "Use both depth and width as the input to MoE-based LoRA."
            )
        },
    )
    
    width_choice: str = field(
        default=None,
        metadata={
            "help": (
                "candidate width list."
            )
        },
    )
